...
// tricks:
// 1. use noise. randomness is boring
// 2. noise is designed for small numbers. scale
// 3. use 3d noise on a 2d plane to make it more variable
// 4. 

// randomness is boring. we want something more than that
// noise is designed for very small ranges
...
// view function only represents the model
